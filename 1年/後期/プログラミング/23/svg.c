...
unsigned int utf8(unsigned char* s) {
    ...
    if ((c & 0x02) ==
        0) {  // 1111 110y 10yy yyxx 10xx xxxx 10xx xxxx 10xx xxxx 10xx xxxx
        unsigned int d = s[1] & 0x3f, e = s[2] & 0x3f, f = s[3] & 0x3f,
                     g = s[4] & 0x3f, h = s[5] & 0x3f;
        //        printf("1111 110y 10yy yyxx 10xx xxxx 10xx xxxx 10xx xxxx 10xx
        //        xxxx\n");
...
unsigned int rgb255(double r, double g, double b) {
    unsigned int r1 = bound255((int)r), g1 = bound255((int)g),
                 b1 = bound255((int)b);
...
void quadrilateral(double x1, double y1, double x2, double y2, double x3,
...
void bezier(double ax0, double ay0, double cx0, double cy0, double cx1,
            double cy1, double ax1, double ay1) {
    printf("<path d=");
...
void bezierVertex(double cx0, double cy0, double cx1, double cy1, double x1,
                  double y1) {
...
void use(const char* url, double x, double y, double w, double h) {
    printf("<g style=\"stroke:%s;stroke-width:%f;stroke-opacity:%f", __stroke,
           __strokeWeight, __strokeOpacity);
    printf(";fill:%s;fill-opacity:%f\">\n", __fill, __fillOpacity);
...
void upperBar(double height) {
    ...
    /*
       ...
       __fillOpacity); printf("    <path d=\"M 0,23.5 L 297,23.5 297,28.5 0,28.5
       0,23.5 Z\"/>\n"); printf("</g>\n");
    */
}
...
void lowerBar(double height) {
    ...
    /*
        printf("<g style=\"stroke:none;fill:%s;fill-opacity:%f\">\n", __fill,
       __fillOpacity); printf("    <path d=\"M 0,181.5 L 297,181.5 297,186.5
       0,186.5 0,181.5 Z\"/>\n"); printf("</g>\n");
    */
}
...
void smilieSymbol1(const char* id) {
    genericSmilieSymbol(
        id,
        "<path style=\"fill:none\" d=\"M 1127,3590 L 1293,3672 1462,3743 1632,3803 1804,3852 1977,3890 2151,3918 2325,3934 2500,3940 2675,3934 2849,3918 3023,3890 3196,3852 3368,3803 3538,3743 3707,3672 3873,3590\"/>");
}

void smilieSymbol2(const char* id) {
    genericSmilieSymbol(
        id, "<line x1=\"1127\" y1=\"4000\" x2=\"3873\" y2=\"4000\" />");
}

void smilieSymbol3(const char* id) {
    genericSmilieSymbol(
        id,
        "<path style=\"fill:none\" d=\"M 1127,4056 L 1293,3974 1462,3903 1632,3843 1804,3794 1977,3756 2151,3728 2325,3712 2500,3707 2675,3712 2849,3728 3023,3756 3196,3794 3368,3843 3538,3903 3707,3974 3873,4056\"/>");
}
